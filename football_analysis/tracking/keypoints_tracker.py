...
class KeypointsTracker(AbstractTracker):
    ...
    def __init__(self, model_path: str, conf: float = 0.1, kp_conf: float = 0.7) -> None:
        ...
        self.scale_x = self.original_size[0] / 640
        self.scale_y = self.original_size[1] / 640
    ...
    def track(self, detection: Results) -> dict:
        ...
        filtered_keypoints = {
            ...
            and 0 <= coords[0] <= 640  # Check if x is within bounds
            and 0 <= coords[1] <= 640  # Check if y is within bounds
        }
