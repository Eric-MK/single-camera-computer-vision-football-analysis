...
def main():
    ...
    obj_tracker = ObjectTracker(
        model_path='models/weights/object.pt',    # Object Detection Model Weights Path
    ...
    kp_tracker = KeypointsTracker(
        model_path='models/weights/keypoint.pt', # Keypoints Model Weights Path
    ...
    process_video(processor,                                # Created FootballVideoProcessor object
                  video_source='input_videos/08fd33_4.mp4', # Video source (in this case video file path)
                  output_video='output_videos/test64016.mp4',    # Output video path (Optional)
